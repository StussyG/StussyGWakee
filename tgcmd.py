...
def valentine(app, message):
    global number
    number = number + 1
    app.edit(f'<b>Кидаю step, лечу прям вверх</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Мой красный сет убил их всех</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>У них в башке один preset</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я покажу тоннельный свет</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Им не найти меня, я скрылся</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я пропавший в dissimilate</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я оставлю им и следа</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Из ниоткуда выйду в late</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Разрубаю глефой ноги, я бегу, за спиной боги (а-а)</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Как на ринге, только в лобби, ты подох, бля (ха-ха)</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я стреляю, это step, бро, you low (pow-pow)</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я быстрее этих lameов, you slow, братан</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я useаю эти spellы, это мой life steal</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я sipую эти stepы, это жёсткий стиль</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Долбоёб назвал НН-ом, я его простил</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я убил их, даже не завейстил сил</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Погасил этих псин, курю бензин, Im steel</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Показал им старый стиль, добил их всех, а кто спросил?</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Astral step поразил долбоёбов и терпил</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>У меня сотка гулей, посмотри, ты вновь один</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Вот ты прикинь, челы чё-то там на Dota-рэп гонят, да</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>А я за один квартал лям рублей получил, бля</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Лимон за Dota-рэп, ха-ха-ха-ха</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>В моих глазах горит квазар</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Иду вперёд, ни шагу назад</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Кидаю step, бегу на старт</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Весь твой профит идёт на спад</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Стреляю метко, как солдат</b>')
    sleep(1)
    ...
    app.send_message(message.chat.id,f'<b>Им не найти меня, я скрылся</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я пропавший в dissmilate</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я оставлю им и следа</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Из ниоткуда выйду в late</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Hunter on ghoul, я убил их всех</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Уворот от пуль, у меня есть вес</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Нахуй граммовка, у меня есть весы</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Я не злодей, но у меня свои бесы</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Много валюты, имею и песо</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Мало HP, я накину им вессел</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Много энергии, я будто Тесла</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Стреляю так метко, все пули прям в висок, ах</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>В моих глазах горит квазар</b>')
    sleep(1)
    app.send_message(message.chat.id,f'<b>Иду вперёд, ни шагу назад</b>')
...
📙<b> Команды:</b> \n<b> - https://telegra.ph/Aktualnye-komandy-03-12 \n

💎 <b>По поводу дополнительный анимаций обращаться сюда: </b>\n <b>- https://t.me/stussyg</b> \n                             
...
@app.on_message(filters.command("loveis", prefixes=".") & filters.me)
def valentine(_, msg):
    txt = loveis.split("\n\n")
    e = True
    etime = int(msg.text.split('.loveis', maxsplit=1)[1])
    for i in txt:
        time = etime
        if e == True:
            e = False
...
❌<b>Запущена программа удалению любви</b> ❌
...
<b>Прекращение программы удалению любви</b>

<b>Пользователь вас любит</b>
